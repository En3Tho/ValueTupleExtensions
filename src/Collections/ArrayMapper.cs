...
namespace En3Tho.ValueTupleExtensions.Collections
{
    ...
    internal readonly ref struct ArrayMapperI<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7>
    {
        public readonly TResult1[] Result1;
        public readonly TResult2[] Result2;
        public readonly TResult3[] Result3;
        ...
        public readonly TResult6[] Result6;
        public readonly TResult7[] Result7;
        private readonly Func<TSource, int, TResult1> _mapper1;
        private readonly Func<TSource, int, TResult2> _mapper2;
        private readonly Func<TSource, int, TResult3> _mapper3;
        private readonly Func<TSource, int, TResult4> _mapper4;
        private readonly Func<TSource, int, TResult5> _mapper5;
        private readonly Func<TSource, int, TResult6> _mapper6;
        private readonly Func<TSource, int, TResult7> _mapper7;

        public ArrayMapperI(int count, Func<TSource, int, TResult1> mapper1, Func<TSource, int, TResult2> mapper2, Func<TSource, int, TResult3> mapper3, Func<TSource, int, TResult4> mapper4,
        ...
        public void Map(ref TSource value, int index)
        {
            Result1[index] = _mapper1(value, index);
            Result2[index] = _mapper2(value, index);
            Result3[index] = _mapper3(value, index);
            Result4[index] = _mapper4(value, index);
            Result5[index] = _mapper5(value, index);
            Result6[index] = _mapper6(value, index);
            Result7[index] = _mapper7(value, index);
        }
    }
    ...
    internal readonly ref struct ArrayMapperI<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6>
    {
        public readonly TResult1[] Result1;
        public readonly TResult2[] Result2;
        public readonly TResult3[] Result3;
        ...
        public ArrayMapperI(int count, Func<TSource, int, TResult1> mapper1, Func<TSource, int, TResult2> mapper2, Func<TSource, int, TResult3> mapper3, Func<TSource, int, TResult4> mapper4,
            Func<TSource, int, TResult5> mapper5, Func<TSource, int, TResult6> mapper6)
        {
            (_mapper1, _mapper2, _mapper3, _mapper4, _mapper5, _mapper6) = (mapper1, mapper2, mapper3, mapper4, mapper5, mapper6);
            (Result1, Result2, Result3, Result4, Result5, Result6) = (new TResult1[count], new TResult2[count], new TResult3[count], new TResult4[count], new TResult5[count], new TResult6[count]);
        }
    ...
    internal readonly ref struct ArrayMapperI<TSource, TResult1, TResult2, TResult3, TResult4, TResult5>
    {
        public readonly TResult1[] Result1;
        public readonly TResult2[] Result2;
        public readonly TResult3[] Result3;
    ...
    internal readonly ref struct ArrayMapperI<TSource, TResult1, TResult2, TResult3, TResult4>
    {
        public readonly TResult1[] Result1;
        public readonly TResult2[] Result2;
        public readonly TResult3[] Result3;
    ...
    internal readonly ref struct ArrayMapperI<TSource, TResult1, TResult2, TResult3>
    {
        public readonly TResult1[] Result1;
        public readonly TResult2[] Result2;
        public readonly TResult3[] Result3;
        ...
        public ArrayMapperI(int count, Func<TSource, int, TResult1> mapper1, Func<TSource, int, TResult2> mapper2, Func<TSource, int, TResult3> mapper3)
        {
            (_mapper1, _mapper2, _mapper3) = (mapper1, mapper2, mapper3);
            (Result1, Result2, Result3) = (new TResult1[count], new TResult2[count], new TResult3[count]);
        }
    ...
    internal readonly ref struct ArrayMapperI<TSource, TResult1, TResult2>
    {
        public readonly TResult1[] Result1;
        public readonly TResult2[] Result2;
        private readonly Func<TSource, int, TResult1> _mapper1;
        ...
        public ArrayMapperI(int count, Func<TSource, int, TResult1> mapper1, Func<TSource, int, TResult2> mapper2)
        {
            (_mapper1, _mapper2) = (mapper1, mapper2);
            (Result1, Result2) = (new TResult1[count], new TResult2[count]);
        }
