...
namespace En3Tho.ValueTupleExtensions.Collections
{
    ...
    {
        public static TResult[] SelectToArray<TSource, TResult>(this IList<TSource> source, Func<TSource, TResult> mapper)
        {
        ...
        public static (TResult1[], TResult2[]) MultiSelect<TSource, TResult1, TResult2>(this IList<TSource> source, Func<TSource, TResult1> mapper1, Func<TSource, TResult2> mapper2)
        {
        ...
        public static (TResult1[], TResult2[], TResult3[]) MultiSelect<TSource, TResult1, TResult2, TResult3>(this IList<TSource> source, Func<TSource, TResult1> mapper1, Func<TSource, TResult2> mapper2,
        ...
        public static (TResult1[], TResult2[], TResult3[], TResult4[]) MultiSelect<TSource, TResult1, TResult2, TResult3, TResult4>(this IList<TSource> source, Func<TSource, TResult1> mapper1,
        ...
        public static (TResult1[], TResult2[], TResult3[], TResult4[], TResult5[]) MultiSelect<TSource, TResult1, TResult2, TResult3, TResult4, TResult5>(this IList<TSource> source,
        ...
        public static (TResult1[], TResult2[], TResult3[], TResult4[], TResult5[], TResult6[]) MultiSelect<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6>(this IList<TSource> source,
            Func<TSource, TResult1> mapper1, Func<TSource, TResult2> mapper2, Func<TSource, TResult3> mapper3, Func<TSource, TResult4> mapper4, Func<TSource, TResult5> mapper5,
