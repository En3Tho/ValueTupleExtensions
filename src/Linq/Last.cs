...
namespace En3Tho.ValueTupleExtensions.Linq
{
    public static partial class IEnumerableToValueTupleExtensions
    {
        public static (TSource, TSource) Last<TSource>(this IEnumerable<TSource> source, Func<TSource, bool> predicate1, Func<TSource, bool> predicate2)
        {
            ...
            {
                var helper = new LastListHelper<TSource>(list);
            ...
            else
            {
                ...
                {
                    var helper = new LastEnumerableHelper<TSource>(enumerator);
                    helper.SetValues(ref result1, ref result2, ref found1, ref found2, predicate1, predicate2);
                }
            }
            ...
            Func<TSource, bool> predicate2, Func<TSource, bool> predicate3, Func<TSource, bool> predicate4)
        {
            ...
            {
                var helper = new LastListHelper<TSource>(list);
                helper.SetValues(ref result1, ref result2, ref result3, ref result4, ref found1, ref found2, ref found3, ref found4, predicate1, predicate2, predicate3,
                    predicate4);
            }
            else
            {
