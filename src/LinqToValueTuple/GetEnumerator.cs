namespace En3Tho.ValueTupleExtensions.LinqToValueTuple
{
    public static partial class ValueTupleLinqLikeExtensions
    {
        ...
        public static ValueTuple2Enumerator<T> GetEnumerator<T>(in this (T, T) tuple) => new ValueTuple2Enumerator<T>(tuple);
        public static ValueTuple3Enumerator<T> GetEnumerator<T>(in this (T, T, T) tuple) => new ValueTuple3Enumerator<T>(tuple);
        public static ValueTuple4Enumerator<T> GetEnumerator<T>(in this (T, T, T, T) tuple) => new ValueTuple4Enumerator<T>(tuple);
        public static ValueTuple5Enumerator<T> GetEnumerator<T>(in this (T, T, T, T, T) tuple) => new ValueTuple5Enumerator<T>(tuple);
        public static ValueTuple6Enumerator<T> GetEnumerator<T>(in this (T, T, T, T, T, T) tuple) => new ValueTuple6Enumerator<T>(tuple);
        public static ValueTuple7Enumerator<T> GetEnumerator<T>(in this (T, T, T, T, T, T, T) tuple) => new ValueTuple7Enumerator<T>(tuple);
    }
}