...
namespace En3Tho.ValueTupleExtensions.LinqToValueTuple
{
    public static partial class ValueTupleLinqLikeExtensions
    {
        ...
        public static T Max<T>(in this (T v1, T v2, T v3, T v4, T v5, T v6, T v7) tuple) where T: IComparable<T>
        {
            var num = tuple.v1.CompareTo(tuple.v2) == 1 ? tuple.v1 : tuple.v2;
            if (num.CompareTo(tuple.v3) == 1) num = tuple.v3;
            if (num.CompareTo(tuple.v4) == 1) num = tuple.v4;
            if (num.CompareTo(tuple.v5) == 1) num = tuple.v5;
            if (num.CompareTo(tuple.v6) == 1) num = tuple.v6;
            return num.CompareTo(tuple.v7) == 1 ? tuple.v7 : num;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Max<T>(in this (T v1, T v2, T v3, T v4, T v5, T v6) tuple) where T: IComparable<T>
        {
            var num = tuple.v1.CompareTo(tuple.v2) == 1 ? tuple.v1 : tuple.v2;
            if (num.CompareTo(tuple.v3) == 1) num = tuple.v3;
            if (num.CompareTo(tuple.v4) == 1) num = tuple.v4;
            if (num.CompareTo(tuple.v5) == 1) num = tuple.v5;
            return num.CompareTo(tuple.v6) == 1 ? tuple.v6 : num;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Max<T>(in this (T v1, T v2, T v3, T v4, T v5) tuple) where T: IComparable<T>
        {
            var num = tuple.v1.CompareTo(tuple.v2) == 1 ? tuple.v1 : tuple.v2;
            if (num.CompareTo(tuple.v3) == 1) num = tuple.v3;
            if (num.CompareTo(tuple.v4) == 1) num = tuple.v4;
            return num.CompareTo(tuple.v5) == 1 ? tuple.v5 : num;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Max<T>(in this (T v1, T v2, T v3, T v4) tuple) where T: IComparable<T>
        {
            var num = tuple.v1.CompareTo(tuple.v2) == 1 ? tuple.v1 : tuple.v2;
            if (num.CompareTo(tuple.v3) == 1) num = tuple.v3;
            return num.CompareTo(tuple.v4) == 1 ? tuple.v4 : num;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Max<T>(in this (T v1, T v2, T v3) tuple) where T: IComparable<T>
        {
            var num = tuple.v1.CompareTo(tuple.v2) == 1 ? tuple.v1 : tuple.v2;
            return num.CompareTo(tuple.v3) == 1 ? tuple.v3 : num;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Max<T>(in this (T v1, T v2) tuple) where T: IComparable<T>
        {
            return tuple.v1.CompareTo(tuple.v2) == 1 ? tuple.v1 : tuple.v2;
        }
